                ...
                <Col xs="5">
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      <p className="card-category font-kanit">รายได้ที่เก็บได้เดือนนี้</p>
                      <Card.Title as="h4">50,000</Card.Title>
                    </div>
                  </Col>
                </Row>
              </Card.Body>
            ...
            <Card className="card-stats">
              <Card.Body>
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      <p className="card-category font-kanit">จำนวนลูกค้าทั้งหมด</p>
