...
function AddressSelector({ setAddressId , initProvince , initSubDistrict , initDistrict , initZipCode }) {
  ...
  const handleProvinceChange = (value) => {
    ...
    setAddressId(addressCode[zipCodeData[districtData[cityData[value][0]][0]][0]]);
};
